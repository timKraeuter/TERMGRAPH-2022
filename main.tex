...
Due to SPO rewriting, a graph transformation rule is a graph morphism $L \to R$, while $L$ and $R$ are typed attributed graphs. 
...
\Cref{fig:gtRuleAbstract} depicts an example graph transformation rule for a NSE in abstract syntax. 
