...
% TODO: make it flow with the part before. Remove the part before since we know to explain things in detail.
% Make the part before highlighting how we generate a start graph and a set of rules depending on the flow nodes as described now:
...
% End Event + General termination rule.
