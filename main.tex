...
We explain rule generation for process instantiation and termination, activities, gateways, and message events.
...
In the case of no start event in the subprocess, a token for every activity and gateway without incoming sequence flows is created.
...
A generic rule terminates subprocesses if they neither have tokens nor subprocesses (see section \ref{subsec:instAndTermination}).
