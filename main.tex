...
The \gls*{bpmn} is a widely used standard notation to define intra- and inter-organizational workflows with the goal of improving the communication between domain experts and software developers.
...
% Describe which tasks are supported and which other tasks are meant by AT.
...
\Cref{tab:supportedconstructs} depicts which constructs of the BPMN execution semantics are supported by the different approaches and our approach.
...
% Future work
% Performance evaluation compared to other approaches and these repositories cited in the other papers
% More semantics
