...
Model checking a BPMN process model is possible using the generated graph grammar.
...
% Summary
The approach presented in this paper utilizes a model transformation from BPMN models to graph grammars. 
For each BPMN model, we automatically generate a start graph and a set of graph transformation rules.
In this way, the graph transformation rules get simpler while the complexity is shifted to the model transformation from BPMN to graph grammars.
